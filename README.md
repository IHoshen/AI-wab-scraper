This project demonstrates how to build an AI-powered web scraper using Python. The application allows users to input a URL, from which it scrapes the site's DOM content. 
